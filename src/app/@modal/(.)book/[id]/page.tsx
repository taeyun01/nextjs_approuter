...
//? 디테일 페이지에 메타 데이터를 설정했지만 인터셉팅 라우트에는 적용되지 않는다.
//? 메타데이터들은 클라이언트 사이드에서 페이지를 이동할 때 필요한게 아니라, 페이지의 주소를 공유하거나 초기 접속을 할 때 굉장히 중요하게 사용되는 태그이기 때문에
//? 인터셉팅 라우트 환경에서는 메타데이터가 그렇게 중요하지않다.
